            ...
            <div className="max-w-7xl mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    <div className="mb-4 md:mb-0">
                        <h3 className="text-lg font-semibold">About CODERS Profiles</h3>
                        <p className="text-yellow-600 mt-2 text-sm max-w-xs">
                            CODER Profiles consolidates all your coding profiles in one place. Track your progress, compare with peers, and showcase your skills.
                        </p>
                    </div>
                    ...
                    <div className="text-sm">
                        <p>Contact us: <a href="mailto:singhankesh672@gmail.com" className="text-yellow-600">singhankesh672@gmail.com</a></p>
